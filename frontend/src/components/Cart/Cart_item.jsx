        ...
        <div className="w-full h-fit py-1 flex bg-white border-b border-gray-300">
          ...
          <div className="h-full w-2/3">
            ...
            <div className="h-1/5 my-1 mx-2 lg:mx-0 flex items-center">
              <div className="h-full mr-3 flex items-center">{data.size}</div>
            ...
            <div className="h-1/5 w-full my-1 mx-2 lg:mx-0 flex">
              ...
              >
                <FaMinus
                  className={data.number <= 1 ? "text-gray-600" : "text-black"}
                />
              </button>
            ...
            <button
              className="w-1/4 mt-1 float-right rounded-md btn-secondary"
              onClick={() => {
                handleAbort();
              }}
            >
        ...
        <div className="h-1/4 w-full p-1 flex bg-white">
          ...
          <div className="h-full w-1/2 px-1">
            <div className="h-1/3 w-full py-auto flex justify-between font-semibold text-xl text-gray-500">
              <div className="h-full w-4/5 truncate">{data.name}</div>
              <button
                className="px-3 rounded btn-secondary"
                onClick={() => {
                  handleAbort();
                  setTimeout(() => {
            ...
            <div className="h-1/6 w-full pt-3 flex items-center">
              ...
              <span className="text-gray-500 text-xl mx-3">{data.size}</span>
            </div>
            <div className="h-1/6 w-full pt-3 flex items-center">
